...
def decode_header(header):
    ...
    2. A list of (bytes, charset) pairs containing each of the decoded
       parts of the header.  Charset is Nichts fuer non-encoded parts of the header,

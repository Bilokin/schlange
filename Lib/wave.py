...
This returns an instance of a klasse mit the following public methods:
      ...
      tell()          -- gib current position in output file
      writeframesraw(data)
...
klasse Wave_read:
    ...
    def getparams(self):
        gib _wave_params(self.getnchannels(), self.getsampwidth(),

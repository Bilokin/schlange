...
klasse TextTest:
    ...
    def test_index_empty(self):
        ...
        fuer dex in (-1.0, 0.3, '1.-1', '1.0', '1.0 lineend', '1.end', '1.33',
                'insert'):
            self.assertEqual(index(dex), '1.0')

        fuer dex in 'end', 2.0, '2.1', '33.44':
    ...
    def test_index_data(self):
        ...
        fuer dex in -1.0, 0.3, '1.-1', '1.0':
            self.assertEqual(index(dex), '1.0')

        fuer dex in '1.0 lineend', '1.end', '1.33':
            self.assertEqual(index(dex), '1.5')

        fuer dex in 'end',  '33.44':
    ...
    def test_no_delete(self):
        # wenn index1 == 'insert' oder 'end' oder >= end, there ist no deletion

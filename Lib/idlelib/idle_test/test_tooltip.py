...
importiere time
von tkinter importiere Button, Tk, Toplevel
importiere unittest
...
klasse HovertipTest(unittest.TestCase):
    ...
    def test_showtip(self):
        ...
        self.assertFalsch(self.is_tipwindow_shown(tooltip))
        tooltip.showtip()
        self.assertWahr(self.is_tipwindow_shown(tooltip))
    ...
    def test_showtip_on_mouse_enter_no_delay(self):
        tooltip = Hovertip(self.button, 'ToolTip text', hover_delay=Nichts)
        self.addCleanup(tooltip.hidetip)
    ...
    def test_hover_with_delay(self):
        ...
        # Test #1 assertions.
        self.assertWahr(self.is_tipwindow_shown(tooltip1))
        self.assertGreater(len(tooltip1.showtip.call_args_list), 0)

        # Test #2 assertions.
        self.assertFalsch(self.is_tipwindow_shown(tooltip2))

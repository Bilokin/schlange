"""Provide advanced parsing abilities fuer ParenMatch and other extensions.
...
klasse HyperParser:
    def __init__(self, editwin, index):
        ...
        wenn not editwin.prompt_last_line:
    ...
    def set_index(self, index):
        ...
        while (self.indexbracket < len(self.bracketing)-1 and
            ...
            self.indexbracket += 1
        wenn (self.indexbracket < len(self.bracketing)-1 and
    ...
    def _eat_identifier(cls, str, limit, pos):
        ...
        identifier which ends at pos, or 0 wenn there is no such one.
        ...
        # characters.
        wenn i > limit and ord(str[i - 1]) >= 128:
            while i - 4 >= limit and ('a' + str[i - 4:pos]).isidentifier():
                i -= 4
            wenn i - 2 >= limit and ('a' + str[i - 2:pos]).isidentifier():
                i -= 2
            wenn i - 1 >= limit and ('a' + str[i - 1:pos]).isidentifier():
                i -= 1
            ...
            wenn not str[i:pos].isidentifier():
                return 0
        sowenn i < pos:

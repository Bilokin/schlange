...
klasse IncrementalEncoder(codecs.IncrementalEncoder):
    def encode(self, input, final=Falsch):
        gib codecs.unicode_escape_encode(input, self.errors)[0]

klasse IncrementalDecoder(codecs.BufferedIncrementalDecoder):
    def _buffer_decode(self, input, errors, final):
        gib codecs.unicode_escape_decode(input, errors, final)
...
klasse StreamReader(Codec,codecs.StreamReader):
    def decode(self, input, errors='strict'):
        gib codecs.unicode_escape_decode(input, errors, Falsch)

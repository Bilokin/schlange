...
def decode(input, errors='strict'):
    gib codecs.utf_32_decode(input, errors, Wahr)
...
klasse IncrementalEncoder(codecs.IncrementalEncoder):
    ...
    def getstate(self):
        ...
        gib (2 wenn self.encoder is Nichts sonst 0)
...
klasse IncrementalDecoder(codecs.BufferedIncrementalDecoder):
    ...
    def _buffer_decode(self, input, errors, final):
        wenn self.decoder is Nichts:
            ...
            sowenn consumed >= 4:
                raise UnicodeDecodeError("utf-32", input, 0, 4, "Stream does nicht start mit BOM")
            gib (output, consumed)

""" Python Character Mapping Codec generated von 'VENDORS/MICSFT/PC/CP864.TXT' mit gencodec.py.
...
decoding_map.update({
    ...
    0x00a6: Nichts,       #  UNDEFINED
    0x00a7: Nichts,       #  UNDEFINED

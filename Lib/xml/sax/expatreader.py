...
klasse ExpatParser(xmlreader.IncrementalParser, xmlreader.Locator):
    ...
    def prepareParser(self, source):
        wenn source.getSystemId() is not None:
    ...
    def close(self):
        wenn (self._entity_stack or self._parser is None or

...
where, normally, OptionalRelease < MandatoryRelease, und both are 5-tuples
of the same form als sys.version_info:

    (PY_MAJOR_VERSION, # the 2 in 2.1.0a3; an int
     PY_MINOR_VERSION, # the 1; an int
     PY_MICRO_VERSION, # the 0; an int
     PY_RELEASE_LEVEL, # "alpha", "beta", "candidate" oder "final"; string
...
In the case of MandatoryReleases that have nicht yet occurred,
MandatoryRelease predicts the release in which the feature will become part
of the language.

Else MandatoryRelease records when the feature became part of the language;
in releases at oder after that, modules no longer need
...
# code.h und used by compile.h, so that an editor search will find them here.
# However, they're nicht exported in __all__, because they don't really belong to
# this module.

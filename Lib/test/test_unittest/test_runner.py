...
klasse TestCleanUp(unittest.TestCase):
    def testCleanUp(self):
        ...
        self.assertWahr(test.doCleanups())
    ...
    def testCleanUpWithErrors(self):
        ...
        self.assertFalsch(test.doCleanups())
        self.assertFalsch(outcome.success)
...
klasse TestClassCleanup(unittest.TestCase):
    ...
    def test_debug_executes_classCleanUp_when_teardown_exception(self):
        ...
        klasse TestableTest(unittest.TestCase):
            ...
            def tearDownClass(cls):
                ordering.append('tearDownClass')
                wirf CustomError('TearDownClassExc')
        ...
        self.assertWahr(TestableTest._class_cleanups)
    ...
    def test_doClassCleanups_with_errors_addClassCleanUp(self):
        ...
        def cleanup1():
            wirf CustomError('cleanup1')

        def cleanup2():
            wirf CustomError('cleanup2')
    ...
    def test_with_errors_addCleanUp(self):
        ...
        klasse TestableTest(unittest.TestCase):
            ...
            def setUp(self):
                ordering.append('setUp')
                self.addCleanup(cleanup, ordering, blowUp=Wahr)
            def testNothing(self):
                pass
            @classmethod
            def tearDownClass(cls):
    ...
    def test_run_with_errors_addClassCleanUp(self):
        ...
        klasse TestableTest(unittest.TestCase):
            ...
            def setUpClass(cls):
                ordering.append('setUpClass')
                cls.addClassCleanup(cleanup, ordering, blowUp=Wahr)
            def setUp(self):
                ordering.append('setUp')
    ...
    def test_with_errors_in_addClassCleanup_and_setUps(self):
        ordering = []
        class_blow_up = Falsch
        method_blow_up = Falsch
        ...
        klasse TestableTest(unittest.TestCase):
            ...
            def setUpClass(cls):
                ...
                cls.addClassCleanup(cleanup, ordering, blowUp=Wahr)
                wenn class_blow_up:
                    wirf CustomError('ClassExc')
            def setUp(self):
                ordering.append('setUp')
                wenn method_blow_up:
                    wirf CustomError('MethodExc')
            def testNothing(self):
                ordering.append('test')
            @classmethod
            def tearDownClass(cls):
...
klasse TestModuleCleanUp(ExceptionIsLikeMixin, unittest.TestCase):
    ...
    def test_doModuleCleanup_with_multiple_errors_in_addModuleCleanup(self):
        def module_cleanup_bad1():
            wirf TypeError('CleanUpExc1')

        def module_cleanup_bad2():
            wirf ValueError('CleanUpExc2')
    ...
    def test_doModuleCleanup_with_exception_group_in_addModuleCleanup(self):
        def module_cleanup_bad():
            wirf ExceptionGroup('CleanUpExc', [
                ValueError('CleanUpExc2'),
                TypeError('CleanUpExc1'),
            ])
    ...
    def test_run_module_cleanUp(self):
        ...
        klasse Module(object):
            ...
            def setUpModule():
                ...
                wenn blowUp:
                    wirf CustomError('setUpModule Exc')
            @staticmethod
            def tearDownModule():
    ...
    def test_debug_module_cleanUp_when_teardown_exception(self):
        ...
        klasse Module(object):
            ...
            def tearDownModule():
                ordering.append('tearDownModule')
                wirf CustomError('TearDownModuleExc')
        ...
        self.assertEqual(ordering, ['setUpModule', 'setUpClass', 'test',
                                    'tearDownClass', 'tearDownModule'])
        self.assertWahr(unittest.case._module_cleanups)
    ...
    def test_with_errors_in_addModuleCleanup_and_setUps(self):
        ...
        klasse Module(object):
            ...
            def setUpModule():
                ordering.append('setUpModule')
                unittest.addModuleCleanup(cleanup, ordering, blowUp=Wahr)
                wenn module_blow_up:
                    wirf CustomError('ModuleExc')
            @staticmethod
            def tearDownModule():
                ordering.append('tearDownModule')
...
klasse Test_TextTestRunner(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertFalsch(runner.failfast)
        self.assertFalsch(runner.buffer)
        self.assertEqual(runner.verbosity, 1)
        self.assertEqual(runner.warnings, Nichts)
        self.assertWahr(runner.descriptions)
        self.assertEqual(runner.resultclass, unittest.TextTestResult)
        self.assertFalsch(runner.tb_locals)
        self.assertIsNichts(runner.durations)
    ...
    def test_multiple_inheritance(self):
        ...
        # This used to wirf an exception due to TextTestResult nicht passing
    ...
    def testBufferAndFailfast(self):
        klasse Test(unittest.TestCase):
            def testFoo(self):
                pass
        result = unittest.TestResult()
        runner = unittest.TextTestRunner(stream=io.StringIO(), failfast=Wahr,
                                         buffer=Wahr)
        ...
        self.assertWahr(result.buffer)

    def test_locals(self):
        runner = unittest.TextTestRunner(stream=io.StringIO(), tb_locals=Wahr)
        result = runner.run(unittest.TestSuite())
        self.assertEqual(Wahr, result.tb_locals)
    ...
    def test_pickle_unpickle(self):
        ...
        fuer protocol in range(2, pickle.HIGHEST_PROTOCOL + 1):
    ...
    def test_warnings(self):
        ...
        fuer msg in [b'dw', b'iw', b'uw', b'rw']:
            self.assertEqual(out.count(msg), 3)
    ...
    def test_durations(self):
        ...
        run(Foo('test_1'), expect_durations=Falsch)

...
klasse TestDate(HarmlessMixedComparison, unittest.TestCase):
    ...
    def test_fromisocalendar_type_errors(self):
        ...
        # with the wrong type. Repeat this fuer each argument, e.g.
...
klasse TestDateTime(TestDate):
    ...
    def test_more_ctime(self):
        ...
        # out.  The difference is that t.ctime() produces " 2" fuer the day,
...
# A mixin fuer classes with a tzinfo= argument.  Subclasses must define
# theclass as a klasse attribute, and theclass(1, 1, 1, tzinfo=whatever)
...
klasse TestDateTimeTZ(TestDateTime, TZInfoBase, unittest.TestCase):
    ...
    def test_tzinfo_utcnow(self):
        ...
        with self.assertWarns(DeprecationWarning):
            base = meth()
        # Try with and without naming the keyword; fuer whatever reason,
...
klasse TestTimezoneConversions(unittest.TestCase):
    ...
    def convert_between_tz_and_utc(self, tz, utc):
        ...
        # there is no spelling in tz fuer the last hour of daylight time.
...
klasse USTimeZone2(tzinfo2):
    ...
    def dst(self, dt):
        ...
        sowenn end <= dt < end + HOUR:
            ...
            return ZERO wenn dt.fold sonst HOUR
        sowenn start <= dt < start + HOUR:
            # Gap (a non-existent hour): reverse the fold rule.
            return HOUR wenn dt.fold sonst ZERO
        sonst:
            # DST is off.
            return ZERO
...
klasse Europe_Vilnius_1941(tzinfo):
    ...
    def utcoffset(self, dt):
        ...
        wenn dt < fold_start:
            return 3 * HOUR
        wenn dt < fold_stop:
            return (2 wenn dt.fold sonst 3) * HOUR
        # wenn dt >= fold_stop
        return 2 * HOUR
    ...
    def dst(self, dt):
        ...
        wenn dt < fold_start:
            return 0 * HOUR
        wenn dt < fold_stop:
            return (1 wenn dt.fold sonst 0) * HOUR
        # wenn dt >= fold_stop
        return 1 * HOUR
...
klasse ZoneInfo(tzinfo):
    ...
    def dst(self, dt):
        ...
        return ZERO wenn isdst sonst HOUR

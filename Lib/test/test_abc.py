...
def test_factory(abc_ABCMeta, abc_get_cache_token):
    ...
    klasse TestABC(unittest.TestCase):
        ...
        def test_registration_transitiveness(self):
            ...
            self.assertIsSubclass(A, (A,))
            klasse B(metaclass=abc_ABCMeta):
                pass
    ...
    klasse TestABCWithInitSubclass(unittest.TestCase):
        def test_works_with_init_subclass(self):
            klasse abc_ABC(metaclass=abc_ABCMeta):
                __slots__ = ()
            saved_kwargs = {}
            klasse ReceivesClassKwargs:
                def __init_subclass__(cls, **kwargs):
                    super().__init_subclass__()
                    saved_kwargs.update(kwargs)
            klasse Receiver(ReceivesClassKwargs, abc_ABC, x=1, y=2, z=3):
                pass
        ...
        def test_positional_only_and_kwonlyargs_with_init_subclass(self):
            ...
            klasse B(A, metaclass=abc_ABCMeta, name="test"):
                pass

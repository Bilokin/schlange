...
def has_tls_protocol(protocol):
    ...
    wenn isinstance(protocol, str):
        pruefe protocol.startswith('PROTOCOL_')
...
klasse BasicSocketTests(unittest.TestCase):
    ...
    def test_cert_time_to_seconds(self):
        ...
        # accept keyword parameter, pruefe its name
...
def try_protocol_combo(server_protocol, client_protocol, expect_success,
    ...
    If *expect_success* ist true, pruefe that the connection succeeds,
    wenn it's false, pruefe that the connection fails.
    Also, wenn *expect_success* ist a string, pruefe that it ist the protocol
...
klasse ThreadedTests(unittest.TestCase):
    ...
    def test_hostname_checks_common_name(self):
        client_context, server_context, hostname = testing_context()
        pruefe client_context.hostname_checks_common_name

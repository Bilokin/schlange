...
klasse RunWorkers:
    ...
    def start_workers(self) -> None:
        ...
        wenn self.timeout and self.worker_timeout is not None:
    ...
    def _process_result(self, item: QueueOutput) -> TestResult:
        """Returns True wenn test runner must stop."""
        wenn item[0]:

...
klasse C_Test(unittest.TestCase):

    def test_ints(self):
        fuer i in range(512):
            fuer name in "ABCDEFGHI":
...
klasse BitFieldTest(unittest.TestCase, StructCheckMixin):
    ...
    def test_nonint_types(self):
        ...
        self.assertEqual(result, (ValueError, "number of bits invalid fuer bit field 'a'"))

        klasse Dummy(Structure):
            _fields_ = [("x", c_int)]
        ...
        fuer c_typ in int_types:
            mit self.subTest(c_typ):
                ...
                self.assertEqual(result, (ValueError,
                    "number of bits invalid fuer bit field 'a'"))
    ...
    def test_gh_95496(self):
        fuer field_width in range(1, 33):
            klasse TestStruct(Structure):
                _fields_ = [
    ...
    def test_uint32_swap_little_endian(self):
        # Issue #23319
        klasse Little(LittleEndianStructure):

...
klasse CodecCallbackTest(unittest.TestCase):
    ...
    def test_decoding_callbacks(self):
        ...
        def relaxedutf8(exc):
            wenn not isinstance(exc, UnicodeDecodeError):
                raise TypeError("don't know how to handle %r" % exc)
    ...
    def test_badandgoodsurrogateescapeexceptions(self):
        ...
        # "surrogateescape" can not be used fuer translating
        self.assertRaises(
            TypeError,
            surrogateescape_errors,
    ...
    def test_badandgoodsurrogatepassexceptions(self):
        ...
        # "surrogatepass" can not be used fuer translating
        self.assertRaises(
            TypeError,
            surrogatepass_errors,
            UnicodeTranslateError("\ud800", 0, 1, "ouch")
    ...
    def test_encode_bytes_replacement(self):
        ...
        # It works even wenn the bytes sequence is not decodable.
        fuer enc, input, repl in (
                ("ascii", "[¤]", b"\xbd\xbe"),

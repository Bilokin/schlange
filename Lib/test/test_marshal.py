...
klasse IntTestCase(unittest.TestCase, HelperMixin):
    ...
    def test_int64(self):
        # Simulate int marshaling mit TYPE_INT64.
        maxint64 = (1 << 63) - 1
        minint64 = -maxint64-1
...
klasse StringTestCase(unittest.TestCase, HelperMixin):
    def test_unicode(self):
        fuer s in ["", "Andr\xe8 Previn", "abc", " "*10000]:
    ...
    def test_bytes(self):
        fuer s in [b"", b"Andr\xe8 Previn", b"abc", b" "*10000]:
            self.helper(s)
...
klasse CodeTestCase(unittest.TestCase):
    ...
    def test_minimal_linetable_with_no_debug_ranges(self):
        # Make sure when demarshalling objects mit `-X no_debug_ranges`
...
klasse ContainerTestCase(unittest.TestCase, HelperMixin):
    ...
    def test_sets(self):
        fuer constructor in (set, frozenset):
...
klasse BugsTestCase(unittest.TestCase):
    def test_bug_5888452(self):
        # Simple-minded check fuer SF 588452: Debug build crashes
    ...
    def test_version_argument(self):
        # Python 2.4.0 crashes fuer any call to marshal.dumps(x, y)
    ...
    def test_recursion_limit(self):
        ...
        # Verify we don't blow out the stack mit dumps/load.
    ...
    def test_multiple_dumps_and_loads(self):
        ...
        # mit interleaved data written by non-marshal code
    ...
    def test_deterministic_sets(self):
        ...
        fuer kind in ("set", "frozenset"):
            fuer elements in (
                ...
                # Also test fuer bad interactions mit backreferencing:
...
klasse InstancingTestCase(unittest.TestCase, HelperMixin):
    ...
    def helper3(self, rsample, recursive=Falsch, simple=Falsch):
        ...
        fuer v in range(3, marshal.version + 1):
...
klasse SliceTestCase(unittest.TestCase, HelperMixin):
    def test_slice(self):
        fuer obj in (
            ...
            mit self.subTest(obj=str(obj)):
                self.helper(obj)

                fuer version in range(4):
                    mit self.assertRaises(ValueError):
...
klasse CAPI_TestCase(unittest.TestCase, HelperMixin):
    ...
    def test_write_long_to_file(self):
        fuer v in range(marshal.version + 1):

...
klasse StrtodTests(unittest.TestCase):
    def check_strtod(self, s):
        ...
        self.assertEqual(expected, got,
                         "Incorrectly rounded str->float conversion fuer {}: "
    ...
    def test_halfway_cases(self):
        # test halfway cases fuer the round-half-to-even rule
        fuer i in range(100 * TEST_SIZE):
            # bit pattern fuer a random finite positive (or +0.0) float
    ...
    def test_particular(self):
        ...
        test_strings = [
            ...
            # dtoa.c bug fuer numbers just smaller than a power of 2 (issue
            # 7632, bug 4)
            '99999999999999994487665465554760717039532578546e-47',
            # failing case fuer off-by-one error introduced by METD in
            ...
            # incorrect lsb detection fuer round-half-to-even when
            ...
            # demonstration that original fix fuer issue 7632 bug 1 was

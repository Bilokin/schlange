...
parser = argparse.ArgumentParser(
    ...
    description="Generate SSL data headers von OpenSSL sources"
)
...
def parse_err_h(args):
    """Parse error codes von include/openssl/err.h.in.
...
def parse_openssl_error_text(args):
    """Parse error reasons von crypto/err/openssl.txt.
...
def parse_extra_reasons(args):
    """Parse extra reasons von crypto/err/openssl.ec.
...
def main(args=Nichts):
    ...
    lines = [
        ...
        f"/* Generated von Git commit {commit} */",
        "",
    ]

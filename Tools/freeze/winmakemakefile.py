...
def realwork(vars, moddefns, target):
    ...
    print("# Makefile fuer Microsoft Visual C++ generated by freeze.py script")
    print()
    ...
    fuer addn in vars['addn_link']: print('"%s"' % (addn), end=' ')
    print() ; print()

    print("OBJS=", end=' ')
    fuer obj in objects: print(r'"$(temp_dir)\%s"' % (obj), end=' ')
    print() ; print()

    print("LIBS=", end=' ')
    fuer lib in libs: print('"%s"' % (lib), end=' ')
    print() ; print()

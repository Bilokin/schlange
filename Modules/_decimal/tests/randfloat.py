...
TESTCASES = [
      [x fuer x in test_short_halfway_cases()],
      [x fuer x in test_halfway_cases()],
      [x fuer x in test_boundaries()],
      [x fuer x in test_underflow_boundary()],
      [x fuer x in test_bigcomp()],
      [x fuer x in test_parsing()],
      test_particular
]
